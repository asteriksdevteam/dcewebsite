...
$.dore = function (element, options) {
  ...
  function init() {
    ...
    if ($().DataTable) {
      ...
      $(".data-table-feature-for-sub-categories-item").DataTable({
      ...
      $(".data-table-feature-for-question-answer").DataTable({
        sDom: '<"row view-filter"<"col-sm-12"<"float-right"l><"float-left"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
        "columns": [
          { "data": "question" },
          { "data": "answer" },
      ...
      $(".data-table-feature-for-sub-categories").DataTable({
        sDom: '<"row view-filter"<"col-sm-12"<"float-right"l><"float-left"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
        "columns": [
          { "data": "name" },
      ...
      $(".data-table-feature-for-services").DataTable({
        sDom: '<"row view-filter"<"col-sm-12"<"float-right"l><"float-left"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
        "columns": [
          { "data": "name" },
          { "data": "Description" },
      ...
      $(".data-table-feature-for-testimonials").DataTable({
        sDom: '<"row view-filter"<"col-sm-12"<"float-right"l><"float-left"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
        "columns": [
          { "data": "name" },
          { "data": "Designation" },
