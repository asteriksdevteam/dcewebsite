                    ...
                    <div class="card-body">
                        ...
                        <div class="col-12 col-lg-12 mb-5">
                            <form action="{{ url('create_blog_db') }}" enctype="multipart/form-data" method="post" onsubmit="return validateDropdown();">
                                ...
                                <div class="form-group has-float-label">
                                    <textarea class="textarea_tinyMice @error('blog_description') is-invalid @enderror" name="blog_description" id="blog_description" required></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-float-label">
                                            <input type="datetime-local" value="" class="form-control form-control-solid date" name="date" id="date" required/>
                                            <span>Date</span>
                                        </div>
                                    </div>
                                </div>
