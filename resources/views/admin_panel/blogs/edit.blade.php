                    ...
                    <div class="card-body">
                        ...
                        <div class="col-12 col-lg-12 mb-5">
                            <form action="{{ url('update_blog') }}" enctype="multipart/form-data" method="post" onsubmit="return validateDropdown();">
                                    ...
                                    <div class="row justify-content-left mt-3 mb-3">
                                        <div class="col-lg-3 col-md-2 col-xs-12">
                                            <div class="card mcard" id="edit_blog_images_show">
                                                <img src="{{ url($Blog->blog_image) }}" width="100px" alt="" srcset="">
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row justify-content-left mt-3 mb-3">
                                        <div class="col-lg-3 col-md-2 col-xs-12">
                                            <div class="card mcard" id="edit_blog_image_thumb_show">
                                                <img src="{{ url($Blog->blog_image_thumb) }}" width="100px" alt="" srcset="">
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                ...
                                <div class="form-group has-float-label">
                                    <textarea type="text" name="edit_blog_description" rows="5" class="form-control" id="edit_blog_description" required>{{ $Blog->blog_description }}</textarea>
